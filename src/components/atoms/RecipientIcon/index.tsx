...
import { type RecipientIconProps } from './types';

const RecipientIconRef: ForwardRefRenderFunction<
  ElementRef<'svg'>,
  RecipientIconProps
> = ({ size = 24, ...props }, ref) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M13.7 4.45001L17.6799 6.75L21.6199 4.46002"
    />
    <path
      strokeWidth="1.5"
      stroke="currentColor"
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.34998 15.45L6.31998 17.75L10.27 15.46"
    />
    <path
      strokeWidth="1.5"
      stroke="currentColor"
...
export const RecipientIcon = forwardRef(RecipientIconRef);
