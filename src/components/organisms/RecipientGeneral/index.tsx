...
import {
  ...
  type RecipientGeneralOutputProps,
} from './types';
...
> = ({ data, className, ...props }, ref) => {
  ...
  const {
    ...
    defaultValues: {
      reference: 'manual',
      type: data?.getRecipient?.NaturalPerson?.cpf ? 'Física' : 'Jurídica',
      legalPerson: {
        id: data?.getRecipient?.legal_person_id ?? '',
        description: data?.getRecipient?.LegalPerson?.cnpj ?? '',
      },
      naturalPerson: {
        id: data?.getRecipient?.natural_person_id ?? '',
        description: data?.getRecipient?.NaturalPerson?.cpf ?? '',
      },
      ...(data?.getRecipient?.LegalPerson?.cnpj && {
        legalPersonManual: {
          cep: data?.getRecipient?.LegalPerson?.cep,
          cnpj: data?.getRecipient?.LegalPerson?.cnpj,
          city: data?.getRecipient?.LegalPerson?.city,
          email: data?.getRecipient?.LegalPerson?.email,

          uf: data?.getRecipient?.LegalPerson?.uf as UfEnum,
          complement: data?.getRecipient?.LegalPerson?.complement,
          first_phone: data?.getRecipient?.LegalPerson?.first_phone,
          third_phone: data?.getRecipient?.LegalPerson?.third_phone,
          fantasy_name: data?.getRecipient?.LegalPerson?.fantasy_name,
          neighborhood: data?.getRecipient?.LegalPerson?.neighborhood,
          public_place: data?.getRecipient?.LegalPerson?.public_place,
          second_phone: data?.getRecipient?.LegalPerson?.second_phone,
          corporate_name: data?.getRecipient?.LegalPerson?.corporate_name,
          address_number: data?.getRecipient?.LegalPerson?.address_number,
          state_registration:
            data?.getRecipient?.LegalPerson?.state_registration,
        },
      }),
      ...(data?.getRecipient?.NaturalPerson?.cpf && {
        naturalPersonManual: {
          rg: data?.getRecipient?.NaturalPerson?.rg,
          cep: data?.getRecipient?.NaturalPerson?.cep,
          cpf: data?.getRecipient?.NaturalPerson?.cpf,
          city: data?.getRecipient?.NaturalPerson?.city,
          name: data?.getRecipient?.NaturalPerson?.name,
          email: data?.getRecipient?.NaturalPerson?.email,
          uf: data?.getRecipient?.NaturalPerson?.uf as UfEnum,
          complement: data?.getRecipient?.NaturalPerson?.complement,
          first_phone: data?.getRecipient?.NaturalPerson?.first_phone,
          nationality: data?.getRecipient?.NaturalPerson?.nationality,
          third_phone: data?.getRecipient?.NaturalPerson?.third_phone,
          neighborhood: data?.getRecipient?.NaturalPerson?.neighborhood,
          public_place: data?.getRecipient?.NaturalPerson?.public_place,
          second_phone: data?.getRecipient?.NaturalPerson?.second_phone,
          address_number: data?.getRecipient?.NaturalPerson?.address_number,
          date_birth: dayjs(
            data?.getRecipient?.NaturalPerson?.date_birth as Date,
          ).toDate(),
          gender:
            data?.getRecipient?.NaturalPerson?.gender === 'Masculino'
              ? 'Masculino'
              : 'Feminino',
        },
      }),
  ...
  const handleUpdate = async (newData: RecipientGeneralOutputProps) => {
    setIsLoading(true);

    try {
      await updateRecipient({
        variables: {
          updateRecipientId: data.getRecipient.id,
          updateRecipientData: {
            ...(newData.type === 'Física' &&
              newData.reference === 'manual' && {
                NaturalPerson: {
                  ...(data?.getRecipient?.NaturalPerson?.rg !==
        ...
        <div className="flex w-full justify-center sm:justify-end">
          <Button
            onClick={handleSubmit((values: unknown) => {
              const update = values as RecipientGeneralOutputProps;
