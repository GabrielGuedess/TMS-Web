...
import {
  ...
  useUpdatePhysicalCustomerQuoteTableMutation,
...
import { physicalCustomerQuoteTableGeneralSchema } from './schema';
import {
  type PhysicalCustomerQuoteTableGeneralProps,
  type PhysicalCustomerQuoteTableGeneralInputProps,
  type PhysicalCustomerQuoteTableGeneralOutputProps,
} from './types';

const PhysicalCustomerQuoteTableGeneralRef: ForwardRefRenderFunction<
  ElementRef<'div'>,
...
> = ({ data, className, ...props }, ref) => {
  ...
  const [updatePhysicalCustomerQuoteTable] =
    useUpdatePhysicalCustomerQuoteTableMutation();
  ...
  const {
    ...
    defaultValues: {
      ...
      nf_serie: data?.getPhysicalCustomerQuoteTable?.nf_serie,
      nf_number: data?.getPhysicalCustomerQuoteTable?.nf_number,
      volume: String(data?.getPhysicalCustomerQuoteTable?.volume),
      amount: String(data?.getPhysicalCustomerQuoteTable?.amount),
  ...
  const handleUpdate = async (
    newData: PhysicalCustomerQuoteTableGeneralOutputProps,
  ) => {
    setIsLoading(true);

    try {
      await updatePhysicalCustomerQuoteTable({
        variables: {
          updatePhysicalCustomerQuoteTableId:
            data?.getPhysicalCustomerQuoteTable?.id ?? '',
        ...
        <div className="flex w-full justify-center sm:justify-end">
          <Button
            onClick={handleSubmit((values: unknown) => {
              const update =
                values as PhysicalCustomerQuoteTableGeneralOutputProps;
...
export const PhysicalCustomerQuoteTableGeneral = forwardRef(
  PhysicalCustomerQuoteTableGeneralRef,
);
