...
import { DataTableSenders } from 'components/organisms/DataTableSenders';

import { type SendersProps } from './types';

const SendersRef: ForwardRefRenderFunction<HTMLElement, SendersProps> = (
  { ...props },
  ref,
) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Remetentes" />
...
export const Senders = forwardRef(SendersRef);
