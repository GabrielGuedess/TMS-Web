...
import { DataTableRecipients } from 'components/organisms/DataTableRecipients';

import { type RecipientsProps } from './types';

const RecipientsRef: ForwardRefRenderFunction<HTMLElement, RecipientsProps> = (
  { ...props },
  ref,
) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Destinatários" />
...
export const Recipients = forwardRef(RecipientsRef);
