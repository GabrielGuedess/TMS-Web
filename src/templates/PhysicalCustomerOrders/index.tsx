...
import { DataTablePhysicalCustomerOrders } from 'components/organisms/DataTablePhysicalCustomerOrders';

import { type PhysicalCustomerOrdersProps } from './types';

const PhysicalCustomerOrdersRef: ForwardRefRenderFunction<
  HTMLElement,
  PhysicalCustomerOrdersProps
> = ({ ...props }, ref) => (
  <section
    ref={ref}
    ...
    {...props}
  >
    <Breadcrumb pageName="Pedidos do Cliente Físico" />
    ...
    <GlowCapture className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-[1.875rem]">
      ...
      <CardDataStats
        ...
        icon={UsersIcon}
        isPositive={false}
        title="Total PhysicalCustomerOrders"
      />
    </GlowCapture>

    <Container>
      <DataTablePhysicalCustomerOrders />
    </Container>
  </section>
);

export const PhysicalCustomerOrders = forwardRef(PhysicalCustomerOrdersRef);
