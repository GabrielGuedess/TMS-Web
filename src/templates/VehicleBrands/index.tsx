...
import { DataTableVehicleBrands } from 'components/organisms/DataTableVehicleBrands';

import { type VehicleBrandsProps } from './types';

const VehicleBrandsRef: ForwardRefRenderFunction<
  HTMLElement,
  VehicleBrandsProps
> = ({ ...props }, ref) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Marcas de Veículos" />
    ...
    <GlowCapture className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-[1.875rem]">
      ...
      <CardDataStats
        ...
        icon={UsersIcon}
        isPositive={false}
        title="Total VehicleBrands"
      />
    </GlowCapture>

    <Container>
      <DataTableVehicleBrands />
    </Container>
  </section>
);

export const VehicleBrands = forwardRef(VehicleBrandsRef);
