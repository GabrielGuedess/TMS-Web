...
import { DataTableCarriers } from 'components/organisms/DataTableCarriers';

import { type CarriersProps } from './types';

const CarriersRef: ForwardRefRenderFunction<HTMLElement, CarriersProps> = (
  { ...props },
  ref,
) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Transportadoras" />
...
export const Carriers = forwardRef(CarriersRef);
