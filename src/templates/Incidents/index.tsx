...
import { DataTableIncidents } from 'components/organisms/DataTableIncidents';

import { type IncidentsProps } from './types';

const IncidentsRef: ForwardRefRenderFunction<HTMLElement, IncidentsProps> = (
  { ...props },
  ref,
) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Incidentes" />
...
export const Incidents = forwardRef(IncidentsRef);
