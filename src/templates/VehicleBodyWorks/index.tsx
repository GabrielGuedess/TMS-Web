...
import { DataTableVehicleBodyWorks } from 'components/organisms/DataTableVehicleBodyWorks';

import { type VehicleBodyWorksProps } from './types';

const VehicleBodyWorksRef: ForwardRefRenderFunction<
  HTMLElement,
  VehicleBodyWorksProps
> = ({ ...props }, ref) => (
  <section
    ref={ref}
    ...
    {...props}
  >
    <Breadcrumb pageName="Carrocerias de Veículos" />
...
export const VehicleBodyWorks = forwardRef(VehicleBodyWorksRef);
