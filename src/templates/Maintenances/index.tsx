...
import { DataTableMaintenances } from 'components/organisms/DataTableMaintenances';

import { type MaintenancesProps } from './types';

const MaintenancesRef: ForwardRefRenderFunction<
  HTMLElement,
  MaintenancesProps
> = ({ ...props }, ref) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Manutenção" />
    ...
    <Container>
      <DataTableMaintenances />
    </Container>
  </section>
);

export const Maintenances = forwardRef(MaintenancesRef);
