...
import { DataTableOwnDrivers } from 'components/organisms/DataTableOwnDrivers';

import { type OwnDriversProps } from './types';

const OwnDriversRef: ForwardRefRenderFunction<HTMLElement, OwnDriversProps> = (
  { ...props },
  ref,
) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Motoristas Próprios" />
...
export const OwnDrivers = forwardRef(OwnDriversRef);
