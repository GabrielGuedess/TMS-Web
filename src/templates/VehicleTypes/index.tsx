...
import { DataTableVehicleTypes } from 'components/organisms/DataTableVehicleTypes';

import { type VehicleTypesProps } from './types';

const VehicleTypesRef: ForwardRefRenderFunction<
  HTMLElement,
  VehicleTypesProps
> = ({ ...props }, ref) => (
  <section
    ...
    {...props}
  >
    <Breadcrumb pageName="Tipos de Veículos" />
    ...
    <GlowCapture className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-[1.875rem]">
      ...
      <CardDataStats
        ...
        icon={UsersIcon}
        isPositive={false}
        title="Total VehicleTypes"
      />
    </GlowCapture>

    <Container>
      <DataTableVehicleTypes />
    </Container>
  </section>
);

export const VehicleTypes = forwardRef(VehicleTypesRef);
