...
import { DataTableICMS } from 'components/organisms/DataTableICMS';

import { type ICMSProps } from './types';

const ICMSRef: ForwardRefRenderFunction<HTMLElement, ICMSProps> = (
  { ...props },
  ref,
) => (
  <section
...
export const ICMS = forwardRef(ICMSRef);
