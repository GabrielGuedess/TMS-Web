...
import { DataTablePhysicalCustomerQuoteTables } from 'components/organisms/DataTablePhysicalCustomerQuoteTables';

import { type PhysicalCustomerQuoteTablesProps } from './types';

const PhysicalCustomerQuoteTablesRef: ForwardRefRenderFunction<
  HTMLElement,
  PhysicalCustomerQuoteTablesProps
> = ({ ...props }, ref) => (
  <section
    ref={ref}
    ...
    {...props}
  >
    <Breadcrumb pageName="Tabela de Cotação de Cliente Físico" />
...
export const PhysicalCustomerQuoteTables = forwardRef(
  PhysicalCustomerQuoteTablesRef,
);
