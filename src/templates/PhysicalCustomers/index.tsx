...
import { DataTablePhysicalCustomers } from 'components/organisms/DataTablePhysicalCustomers';

import { type PhysicalCustomersProps } from './types';

const PhysicalCustomersRef: ForwardRefRenderFunction<
  HTMLElement,
  PhysicalCustomersProps
> = ({ ...props }, ref) => (
  <section
    ref={ref}
    ...
    {...props}
  >
    <Breadcrumb pageName="Clientes Físicos" />
...
export const PhysicalCustomers = forwardRef(PhysicalCustomersRef);
