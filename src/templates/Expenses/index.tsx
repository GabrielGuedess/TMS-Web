...
import { DataTableExpenses } from 'components/organisms/DataTableExpenses';

import { type ExpensesProps } from './types';

const ExpensesRef: ForwardRefRenderFunction<HTMLElement, ExpensesProps> = (
  { ...props },
  ref,
) => (
  <section
...
export const Expenses = forwardRef(ExpensesRef);
